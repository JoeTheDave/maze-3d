...
function ActivateMaze() {
  ...
  if (maze.mazeEntrance.nNeighbor == null) {
    maze.mazeEntrance.nWall = true
  }
  if (maze.mazeEntrance.eNeighbor == null) {
    maze.mazeEntrance.eWall = true
  }
  if (maze.mazeEntrance.sNeighbor == null) {
    maze.mazeEntrance.sWall = true
  }
  if (maze.mazeEntrance.wNeighbor == null) {
    maze.mazeEntrance.wWall = true
  }
  active = true
}
...
$(function () {
  ...
  if (maze.mazeEntrance.x == 0) {
    rY = -90
    dir = 4
  }
  if (maze.mazeEntrance.x == 14) {
    rY = 90
    dir = 2
  }
  if (maze.mazeEntrance.y == 14) {
    rY = 180
    dir = 3
  }
  $('.Maze').css(
  ...
  document.onkeyup = function (e) {
    if (active) {
      ...
      if (KeyID == 38) {
        //forward
        if (dir == 1 && maze.currentPosition.sWall == false) {
          tZ += 400
          maze.currentPosition = maze.currentPosition.sNeighbor
        }
        if (dir == 2 && maze.currentPosition.wWall == false) {
          tX -= 400
          maze.currentPosition = maze.currentPosition.wNeighbor
        }
        if (dir == 3 && maze.currentPosition.nWall == false) {
          tZ -= 400
          maze.currentPosition = maze.currentPosition.nNeighbor
        }
        if (dir == 4 && maze.currentPosition.eWall == false) {
          tX += 400
        ...
        //back
        if (dir == 1 && maze.currentPosition.nWall == false) {
          tZ -= 400
          maze.currentPosition = maze.currentPosition.nNeighbor
        }
        if (dir == 2 && maze.currentPosition.eWall == false) {
          tX += 400
          maze.currentPosition = maze.currentPosition.eNeighbor
        }
        if (dir == 3 && maze.currentPosition.sWall == false) {
          tZ += 400
          maze.currentPosition = maze.currentPosition.sNeighbor
        }
        if (dir == 4 && maze.currentPosition.wWall == false) {
          tX -= 400
          maze.currentPosition = maze.currentPosition.wNeighbor
        }
      } else if (KeyID == 37) {
  ...
  for (var x = 0; x < maze.sections.length; x++) {
    content +=
      '<div class="Cube" style="-webkit-transform: translateZ(' +
      maze.sections[x].y * -400 +
      'px) translateX(' +
      maze.sections[x].x * -400 +
      'px);">'
    if (maze.sections[x].nWall) {
      content +=
        '<div class="Bulkhead" style="-webkit-transform: rotateY(0deg) translateZ(200px);' +
        (maze.sections[x].nNeighbor != null ? ' -webkit-backface-visibility: hidden;' : '') +
        '"></div>'
    }
    if (maze.sections[x].wWall) {
      content +=
        '<div class="Bulkhead" style="-webkit-transform: rotateY(90deg) translateZ(200px);' +
        (maze.sections[x].wNeighbor != null ? ' -webkit-backface-visibility: hidden;' : '') +
        '"></div>'
    }
    if (maze.sections[x].sWall) {
      content +=
        '<div class="Bulkhead" style="-webkit-transform: rotateY(180deg) translateZ(200px);' +
        (maze.sections[x].sNeighbor != null ? ' -webkit-backface-visibility: hidden;' : '') +
        '"></div>'
    }
    if (maze.sections[x].eWall) {
      content +=
        '<div class="Bulkhead" style="-webkit-transform: rotateY(270deg) translateZ(200px);' +
        (maze.sections[x].eNeighbor != null ? ' -webkit-backface-visibility: hidden;' : '') +
        '"></div>'
    }
    if (maze.sections[x].isEntrance) {
      if (maze.sections[x].nNeighbor == null) {
        content +=
          '<div class="Bulkhead" style="-webkit-transform: rotateY(180deg) translateZ(-200px); -webkit-backface-visibility: hidden;"></div>'
      }
      if (maze.sections[x].wNeighbor == null) {
        content +=
          '<div class="Bulkhead" style="-webkit-transform: rotateY(270deg) translateZ(-200px); -webkit-backface-visibility: hidden;"></div>'
      }
      if (maze.sections[x].sNeighbor == null) {
        content +=
          '<div class="Bulkhead" style="-webkit-transform: rotateY(0deg) translateZ(-200px); -webkit-backface-visibility: hidden;"></div>'
      }
      if (maze.sections[x].eNeighbor == null) {
        content +=
          '<div class="Bulkhead" style="-webkit-transform: rotateY(90deg) translateZ(-200px); -webkit-backface-visibility: hidden;"></div>'
      }
    }
    if (maze.sections[x].isExit) {
      if (maze.sections[x].nNeighbor == null) {
        content +=
          '<div id="CanvasContainer" class="Bulkhead" style="-webkit-transform: rotateY(180deg) translateZ(-200px); -webkit-backface-visibility: hidden;"></div>'
      }
      if (maze.sections[x].wNeighbor == null) {
        content +=
          '<div id="CanvasContainer" class="Bulkhead" style="-webkit-transform: rotateY(270deg) translateZ(-200px); -webkit-backface-visibility: hidden;"></div>'
      }
      if (maze.sections[x].sNeighbor == null) {
        content +=
          '<div id="CanvasContainer" class="Bulkhead" style="-webkit-transform: rotateY(0deg) translateZ(-200px); -webkit-backface-visibility: hidden;"></div>'
      }
      if (maze.sections[x].eNeighbor == null) {
        content +=
          '<div id="CanvasContainer" class="Bulkhead" style="-webkit-transform: rotateY(90deg) translateZ(-200px); -webkit-backface-visibility: hidden;"></div>'
      }
    }
    content += '</div>'
  }
    ...
    Initialize: function () {
      ...
      for (var x = 0; x < this.sections.length; x++) {
        if (
          ...
          ((this.sections[x].isOnEntrancePath && this.sections[x].eNeighbor.isOnExitPath) ||
            (this.sections[x].isOnExitPath && this.sections[x].eNeighbor.isOnEntrancePath))
        ) {
        ...
        if (
          ...
          ((this.sections[x].isOnEntrancePath && this.sections[x].sNeighbor.isOnExitPath) ||
            (this.sections[x].isOnExitPath && this.sections[x].sNeighbor.isOnEntrancePath))
        ) {
...
function AddAsset() {
  ...
  path.attr({
    fill: '#' + color.toString(16) + color.toString(16) + color.toString(16),
    stroke: '#' + color.toString(16) + color.toString(16) + color.toString(16),
    opacity: 0.0,
  })
  txt.toFront()
  path.animate(
